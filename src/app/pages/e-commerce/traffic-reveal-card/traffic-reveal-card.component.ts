...
import { TrafficList, TrafficListData } from '../../../infrastructure/@core/data/traffic-list';
import { TrafficBarData, TrafficBar } from '../../../infrastructure/@core/data/traffic-bar';
